...
QT_MOC_LITERAL(3, 26, 8), // "nickname"
...
QT_MOC_LITERAL(7, 107, 21) // "on_pushButton_clicked"
    ...
    "Widget\0loginSuccessfully\0\0nickname\0"
...
void Widget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Widget::loginSuccessfully)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Widget::loginSuccessfully(QString _t1)
{
